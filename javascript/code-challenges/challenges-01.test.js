...
const speaker = (words, callback) => {
  ...
  words.forEach((element) => {
    greetingArr.push(callback(element));
  });
  return(greetingArr);
};
...
const addNumbers = (num, arr, times, callback) => {
  // I can't figure out how to make this a forEach loop, since it starts with an empty array
